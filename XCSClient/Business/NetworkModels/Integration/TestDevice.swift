...
struct TestDevice: Codable {
    ...
    let retina: String? // false,
    let revision: String? // "724-9161aecc76fc6eada17a5fd6a0867f39",
    let simulator: String? // true,
    let supported: String? // true,
    let tinyID: String? // "951D6FF",
    let trusted: String? // true,
    let wireless: String? // false
}
